...
export class Rational implements Arithmeticable<Rational> {
  ...
  add(racional: Rational) {
    const newNum: number =
      this.num * racional.getDen() + racional.getNum() * this.den;
...
export class Adapter extends Complex {
   ...
   */
  constructor(private rationalOp: Rational) {
    super(rationalOp.getNum() / rationalOp.getDen(), 0);
  }
}
...
const collect = new ArithmeticableCollection<Rational | Complex>([
  rational1,
  complex2,
  adapting,
]);
